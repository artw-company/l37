...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-$$h@+%iv=y#0^y*576lbv^0)p43rnp^&t23==ba7*da_rxn=z=")
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DATABASE_NAME", "lot37"),
        "USER": os.getenv("DATABASE_USER", "postgres"),
        "PASSWORD": os.getenv("DATABASE_PASSWORD", "postgres"),
        "HOST": os.getenv("DATABASE_URL", "localhost"),
        "PORT": os.getenv("DATABASE_PORT", 15440),
        "CONN_MAX_AGE": 600,
    }
}
# Auth User Model
